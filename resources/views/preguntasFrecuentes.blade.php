...
<head>
  ...
  <title>Civis · Preguntas Frecuentes</title>
    ...
    <main class="main-wrapper">
      ...
      <header class="navbar">
        <div class="navbar-container">
          ...
          <nav class="nav-links">
            ...
            <a href="{{ route('preguntasFrecuentes') }}" class="nav-link active">Preguntas Frecuentes</a>
          </nav>
      ...
      <div class="content-area">
        ...
        <header class="view-header">
          <h2 class="view-title">Preguntas Frecuentes</h2>
        </header>
        ...
        <div class="faqs-container">
          ...
          <div class="faq-intro">
            <p>Encuentra respuestas rápidas a las preguntas más comunes sobre trámites y gestiones.</p>
          </div>

          <div class="faqs-list" id="faqs-list">
            <!-- Las preguntas frecuentes se cargarán aquí desde la API -->
          </div>
